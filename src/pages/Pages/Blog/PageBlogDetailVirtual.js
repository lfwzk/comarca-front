...
// import images
import ofvirtual01 from "../../../assets/images/blog/ofvirtual/ofvirtual.jpg";
import ofvirtual02 from "../../../assets/images/blog/ofvirtual/ofvirtual1.jpg";
import ofvirtual03 from "../../../assets/images/blog/ofvirtual/ofvirtual2.jpg";

class PageBlogDetailTeam extends Component {
  constructor(props) {
    super(props);
    this.state = {
      pathItems: [
          ...
          <Container>
            <Row className="align-items-center">
              <Col md="6">
                ...
                >
                  <div>
                    <img src={ofvirtual01} className="img-fluid" alt="" />
                  </div>
                  <div>
                    <img src={ofvirtual02} className="img-fluid" alt="" />
                  </div>
                  <div>
                    <img src={ofvirtual03} className="img-fluid" alt="" />
                  </div>
                </Slider>
              </Col>
              ...
              <Col md="6" className="mt-4 mt-sm-0 pt-2 pt-sm-0">
                <div className="section-title ms-md-4">
                  <h4 className="title mb-4">Estacion de trabajo - OF VIRTUAL</h4>
...
export default PageBlogDetailTeam;
