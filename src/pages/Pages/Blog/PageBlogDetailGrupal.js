...
// import images
import team01 from "../../../assets/images/blog/team/team.jpg";
import team02 from "../../../assets/images/blog/team/team1.jpg";
import team03 from "../../../assets/images/blog/team/team2.jpg";
import team04 from "../../../assets/images/blog/team/team3.jpg";
// import images
...
// import images
import emprende01 from "../../../assets/images/blog/enprendedor/emprende.jpg";
import emprende02 from "../../../assets/images/blog/enprendedor/emprende1.jpg";
import emprende03 from "../../../assets/images/blog/enprendedor/emprende2.jpg";
import emprende04 from "../../../assets/images/blog/enprendedor/emprende3.jpg";
import emprende05 from "../../../assets/images/blog/enprendedor/emprende4.jpg";
import emprende06 from "../../../assets/images/blog/enprendedor/emprende5.jpg";

class PageBlogDetailPrivado extends Component {
  constructor(props) {
    super(props);
    this.state = {
      pathItems: [
            ...
            <Row className="align-items-center">
              ...
              <Col md="6" className="mt-4 mt-sm-0 pt-2 pt-sm-0">
                <div className="section-title ms-md-4">
                  <h4 className="title mb-4">Estacion de trabajo - CO TEAM</h4>
          ...
          <Container>
            <Row className="align-items-center">
              <Col md="6">
                ...
                >
                  <div>
                    <img src={emprende01} className="img-fluid" alt="" />
                  </div>
                  <div>
                    <img src={emprende02} className="img-fluid" alt="" />
                  </div>
                  <div>
                    <img src={emprende03} className="img-fluid" alt="" />
                  </div>
                  <div>
                    <img src={emprende04} className="img-fluid" alt="" />
                  </div>
                  <div>
                    <img src={emprende05} className="img-fluid" alt="" />
                  </div>
                  <div>
                    <img src={emprende06} className="img-fluid" alt="" />
                  </div>
                </Slider>
              </Col>
              ...
              <Col md="6" className="mt-4 mt-sm-0 pt-2 pt-sm-0">
                <div className="section-title ms-md-4">
                  <h4 className="title mb-4">Estacion de trabajo - CO EMPRENDEDOR</h4>
                  <div className="d-flex justify-content-between my-4">
                    <h4 className="mb-0">
                      <b>BOB 25.00</b>
                    </h4>
...
export default PageBlogDetailPrivado;
