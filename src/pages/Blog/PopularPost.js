...
// Blog Images
import blog1 from "../../assets/images/blog/comunidad/comunidad.jpg";
import blog2 from "../../assets/images/blog/privado/privado.jpg";
      ...
      blogs: [
        {
          id: 1,
          image: blog1,
          title: "Estacion de trabajo - CO MUNIDAD BOB 25.00",
          like: "33",
          comment: "08",
          autor: "Co Marca",
        },
        {
          id: 2,
          image: blog2,
          title: "Estacion de trabajo-CO PRIVADA BOB 35.00",
          like: "33",
          comment: "08",
          autor: "Co Marca",
        },
          ...
          <Row className="align-items-center mb-4 pb-2">
            <Col md={8}>
              <div className="section-title text-center text-md-start">
                <h4 className="mb-4">Espacios Individual</h4>
          ...
          <Row>
            ...
            <Col xs={12} className="mt-4 pt-2">
              <div className="text-center">
                <Link to="page-servicio-detail" className="btn btn-primary">
                  Mas información{" "}
                  <i>
