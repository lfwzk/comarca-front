...
// Blog Images
import ofvirtual1 from "../../assets/images/blog/ofvirtual/ofvirtual.jpg";
        ...
        <React.Fragment>
            ...
            <Row className="align-items-center mb-4 pb-2">
                ...
                <div className="section-title text-center text-md-start">
                    <h4 className="mb-4">Espacios Virtual</h4>
            ...
            <Row>
                ...
                <div className="text-center">
                    <Link to="page-servicio-detail-virtual" className="btn btn-primary">
                    Mas información{" "}
                    <i>
