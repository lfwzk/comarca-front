...
// servicios
const PageBlogDetail = React.lazy(() => import("./pages/Pages/Blog/PageBlogDetailIndividual"));
const PageBlogDetailPrivado = React.lazy(() => import("./pages/Pages/Blog/PageBlogDetailGrupal"));
const PageBlogDetailCoemprendedor = React.lazy(() => import("./pages/Pages/Blog/PageBlogDetailEmprendedor"));
const PageBlogDetailColaboratorio = React.lazy(() => import("./pages/Pages/Blog/PageBlogDetailLaboratorio"));
const PageBlogDetailTeam = React.lazy(() => import("./pages/Pages/Blog/PageBlogDetailVirtual"));
...
const routes = [
  ...
  { path: "/index-servicios", component: Blog, isTopbarDark: true },
  ...
  //Page Servicios
  { path: "/page-servicio-detail", component: PageBlogDetail, isTopbarDark: true },
  { path: "/page-servicio-detail-private", component: PageBlogDetailPrivado, isTopbarDark: true },
  { path: "/page-servicio-detail-coemprende", component: PageBlogDetailCoemprendedor, isTopbarDark: true },
  { path: "/page-servicio-detail-cola bora", component: PageBlogDetailColaboratorio, isTopbarDark: true },
  { path: "/page-servicio-detail-virtual", component: PageBlogDetailTeam, isTopbarDark: true },
  ...
  //Index Main
  { path: "/", component: Main, isTopbarDark: true },
